...
- default to open and copy to clipboard
  ([73a9b9d](https://github.com/agentofuser/ipfs-deploy/commit/73a9b9d))
...
- support node 11
  ([ae1aec7](https://github.com/agentofuser/ipfs-deploy/commit/ae1aec7))
